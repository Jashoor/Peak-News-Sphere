...
<div class="panel panel-default aa-checkout-billaddress">
  ...
  <div id="collapseThree">
    <div class="panel-body">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="aa-checkout-single-bill">
             Email Address:<span id="idloginid" class="errmsg"></span>
            <input type="text" name="loginid" value="<?php echo $rsedit['loginid']; ?>"placeholder="Email Address">
 ...
 function validateform()
 {
    ...
    var emailExp = /^[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}$/;    
     ...
     if (document.formform.password.value == "" || document.formform.cpassword.value == "") {
        document.getElementById("idpassword").innerHTML = "Password is required.";
        document.getElementById("idcpassword").innerHTML = "Confirm Password is required.";
        checkcondition = false;
     }
     if(document.formform.password.value != document.formform.cpassword.value)
     {
 ...
 function verifyEmail() {
    var email = document.getElementsByName("loginid")[0].value;
    var emailExp = /^[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}$/;
    if (!email.match(emailExp)) {
        document.getElementById("idloginid").innerHTML = "Entered Email ID is not valid";
    } else {
        document.getElementById("idloginid").innerHTML = ""; // Clear any previous error message
        // Add your verification logic here
        // For example, you can send an AJAX request to check if the email exists in the database
    }
}
 </script>
