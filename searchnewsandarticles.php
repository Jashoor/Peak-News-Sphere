...
?>
    ...
    <img src="img/fashion/fashion-header-bg-8.jpg" alt="Fashion Header" style="width:100%;">
   <div class="aa-catg-head-banner-area">
     <div class="container">
      <div class="aa-catg-head-banner-content">
        <h2>Search Result of  News and Articles</h2>
      </div>
     </div>
   </div>
  </section>
  ...
  <section id="aa-blog-archive">
	...
	if($_GET['txtsearch'] != "")
	{
		$sql = $sql . " AND newscontent.title LIKE '%" . $_GET['txtsearch'] . "%' ";
	}
