            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="index.php">
                  ...
                  <div style="width:550px;">&nbsp;<strong>Peak</strong> <strong> News </strong> <strong>Sphere</strong> </div>
                </a>
                <!--  img based logo -->
...
<ul class="nav navbar-nav btn btn-info">
              ...
              <li>
			          <a href="#">Highlights<span class="caret"></span></a>
                <ul class="dropdown-menu">                
                      ...
                      {
                      ?>
                                <li><a href="addhighlights.php?type=Article">Add Highlights</a></li>
                                <li><a href="viewhighlights.php?type=Article">View Highlights</a></li>          
                      <?php
                      }
                      ?>
                </ul>
...
?>
<ul class="nav navbar-nav btn btn-info">
              <li STYLE="padding: 10px 15px;background-color: red;">SELLER MENU >></li>			  
...
?>  
  ...
  <?php
  $sqlscroller= "SELECT highlights.* FROM highlights WHERE highlights.status='Active' ";	
	if($_GET['txtsearch'] != "")
	{
		$sqlscroller = $sqlscroller . " AND highlights.description LIKE '%$_GET[txtsearch]%'";
	}
  $sqlscroller = $sqlscroller . " ORDER BY highlights.highlightsid DESC LIMIT 9";
	$qsqlscroller = mysqli_query($con,$sqlscroller);
  $i=0;
	while($rsscroller = mysqli_fetch_array($qsqlscroller))
	{
    echo "<a style='color: white;' href='#'>"; // Update the href as needed
    echo $rsscroller['description'] . " <span class='marquee__seperator'>+++</span>";
    echo "</a>";
  }
  ?>
</div>
